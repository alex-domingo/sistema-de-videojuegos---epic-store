...
@WebServlet("/api/reportes/biblioteca-familiar/uso")
public class UsuarioReporteUsoBibliotecaFamiliarController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            var r = service.usoBibliotecaFamiliar(idUsuario);
