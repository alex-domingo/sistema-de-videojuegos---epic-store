...
@WebServlet("/api/empresa/reportes/feedback/peores-calificaciones")
public class EmpresaReporteFeedbackPeoresCalificacionesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            var r = service.peoresCalificaciones(idEmpresa, desde, hasta, limit);
