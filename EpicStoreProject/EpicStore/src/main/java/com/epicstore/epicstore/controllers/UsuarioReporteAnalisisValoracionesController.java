...
@WebServlet("/api/reportes/analisis-biblioteca/valoraciones")
public class UsuarioReporteAnalisisValoracionesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            var r = service.valoracionesBiblioteca(idUsuario);
