...
@WebServlet("/api/empresa/comentarios/global")
public class EmpresaComentariosGlobalController extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            CambiarVisibilidadComentariosGlobalDTO dto
                    = gson.fromJson(request.getReader(), CambiarVisibilidadComentariosGlobalDTO.class);

            VideojuegoEmpresaService.Resultado r = service.cambiarVisibilidadGlobal(idEmpresa, dto);
