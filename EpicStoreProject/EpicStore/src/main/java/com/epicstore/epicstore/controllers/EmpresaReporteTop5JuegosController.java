...
@WebServlet("/api/empresa/reportes/top5-juegos")
public class EmpresaReporteTop5JuegosController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            var r = service.top5Juegos(idEmpresa, desde, hasta);
