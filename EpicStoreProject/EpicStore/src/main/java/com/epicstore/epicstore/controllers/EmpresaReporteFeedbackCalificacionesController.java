...
@WebServlet("/api/empresa/reportes/feedback/calificaciones")
public class EmpresaReporteFeedbackCalificacionesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            var r = service.feedbackCalificaciones(idEmpresa, desde, hasta);
